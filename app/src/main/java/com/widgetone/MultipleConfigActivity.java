...
public class MultipleConfigActivity extends AppCompatActivity {
    ...
    private int topicChangeTarget = 5;

    private boolean colourChanged = false;
    private int colourChangedTarget = 5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.multiple_config_activity_layout);
        ...
        confirmButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (configMode.equals("title_config")) {
                    hideKeyboard(MultipleConfigActivity.this);
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (enteredText.length()>0) {
                    ...
                    if (enteredText.charAt(enteredText.length() - 1) == '~') {
                        ...
                        Toast.makeText(MultipleConfigActivity.this, "Sorry, you cannot use the ~ symbol", Toast.LENGTH_SHORT).show();
     ...
     preSetColoursString = preSetColoursString + Integer.toString(backgroundColorList.get(x).getBackgroundColour()) + "~";
      ...
      //  IDseditor.apply();
        ...
        appWidgetManager = AppWidgetManager
                .getInstance(MultipleConfigActivity.this);
        ComponentName thisAppWidget = new ComponentName(
                MultipleConfigActivity.this, MultipleButtonWidget.class);
        int[] appWidgetIds = appWidgetManager
                .getAppWidgetIds(thisAppWidget);
        Intent startBroadcast = new Intent(MultipleConfigActivity.this,
                MultipleButtonWidget.class);
        ...
        Intent buttonOneIntent = new Intent(this, MultipleButtonWidget.class).setAction(ACTION_BUTTON_ONE);
        ...
        Intent buttonTwoIntent = new Intent(this, MultipleButtonWidget.class).setAction(ACTION_BUTTON_TWO);
        ...
        Intent buttonThreeIntent = new Intent(this, MultipleButtonWidget.class).setAction(ACTION_BUTTON_THREE);
        ...
        Intent buttonFourIntent = new Intent(this, MultipleButtonWidget.class).setAction(ACTION_BUTTON_FOUR);
        ...
        Intent buttonFiveIntent = new Intent(this, MultipleButtonWidget.class).setAction(ACTION_BUTTON_FIVE);
        ...
        Intent configIntent = new Intent(this, MultipleConfigActivity.class).setAction(AppWidgetManager.ACTION_APPWIDGET_CONFIGURE);
...
if (backgroundColorList.size()==2) {
    ...
    valuesEditor.putString(KEY_COLOR_FIVE + String.valueOf(appWidgetId), Integer.toString(Color.WHITE));
        ...
        valuesEditor.putString(KEY_TEXT + String.valueOf(appWidgetId), displayedText);
        ...
        if (editTextSelected) {
            ...
            if (Integer.parseInt(notificationsArray[2]) > topicChangeTarget - 1) {
                ...
                Intent diaryIntent = new Intent(MultipleConfigActivity.this, DiaryActivity.class);
