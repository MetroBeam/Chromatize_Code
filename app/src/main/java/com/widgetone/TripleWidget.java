...
import static com.widgetone.TripleWidgetConfig.KEY_COLOR_FIVE;
import static com.widgetone.TripleWidgetConfig.KEY_COLOR_FOUR;
import static com.widgetone.TripleWidgetConfig.KEY_COLOR_ONE;
import static com.widgetone.TripleWidgetConfig.KEY_COLOR_THREE;
import static com.widgetone.TripleWidgetConfig.KEY_COLOR_TWO;

import static com.widgetone.TripleWidgetConfig.TRIPLE_KEY_TEXT;

import static com.widgetone.TripleWidgetConfig.KEY_VISIBILITY_FIVE;
import static com.widgetone.TripleWidgetConfig.KEY_VISIBILITY_FOUR;
import static com.widgetone.TripleWidgetConfig.KEY_VISIBILITY_ONE;
import static com.widgetone.TripleWidgetConfig.KEY_VISIBILITY_THREE;
import static com.widgetone.TripleWidgetConfig.KEY_VISIBILITY_TWO;

import static com.widgetone.TripleWidgetConfig.VALUES_SHARED_PREFS;
 ...
 */
public class TripleWidget extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            */
            ...
            String tText = valuePreferences.getString(TRIPLE_KEY_TEXT + String.valueOf(appWidgetId), "D");
            ...
            Intent flowerSelectIntent = new Intent(context, TripleWidget.class).setAction(ACTION_FLOWER);
            PendingIntent pendingIntentFlowerSelect = PendingIntent.getBroadcast(context,
                    appWidgetId, flowerSelectIntent, PendingIntent.FLAG_UPDATE_CURRENT);

            Intent captureSelectIntent = new Intent(context, TripleWidget.class).setAction(ACTION_CAPTURE);
            PendingIntent pendingIntentCaptureSelect = PendingIntent.getBroadcast(context,
                    appWidgetId, captureSelectIntent, PendingIntent.FLAG_UPDATE_CURRENT);


            Intent buttonOneIntent = new Intent(context, TripleWidget.class).setAction(ACTION_BUTTON_ONE);
            ...
            Intent buttonTwoIntent = new Intent(context, TripleWidget.class).setAction(ACTION_BUTTON_TWO);
            ...
            Intent buttonThreeIntent = new Intent(context, TripleWidget.class).setAction(ACTION_BUTTON_THREE);
            ...
            Intent buttonFourIntent = new Intent(context, TripleWidget.class).setAction(ACTION_BUTTON_FOUR);
            ...
            Intent buttonFiveIntent = new Intent(context, TripleWidget.class).setAction(ACTION_BUTTON_FIVE);
            ...
            Intent configIntent = new Intent(context, TripleWidgetConfig.class).setAction(AppWidgetManager.ACTION_APPWIDGET_CONFIGURE);
            ...
            RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.triple_app_widget);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (ACTION_FLOWER.equals(action)) {

            Intent activityIntent = new Intent(context, MainActivity.class);
            activityIntent.putExtra("flower", "flower");
            activityIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            context.startActivity(activityIntent);
        }
        ...
        if (ACTION_CAPTURE.equals(action)) {
            ...
            Intent activityIntent = new Intent(context, MainActivity.class);
            activityIntent.putExtra("capture", "capture");
            activityIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            context.startActivity(activityIntent);
        }
