...
import static com.widgetone.CaptureConfigActivity.CAPTURE_KEY_TEXT;
import static com.widgetone.CaptureConfigActivity.VALUES_SHARED_PREFS;

public class CaptureWidget extends AppWidgetProvider {

    public static final String ACTION_BUTTON_ONE = "ACTION_BUTTON_SHARE";
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        Intent configIntent = new Intent(context, CaptureConfigActivity.class).setAction(AppWidgetManager.ACTION_APPWIDGET_CONFIGURE);
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.capture_app_widget);
        ...
        String tText = preferences.getString(CAPTURE_KEY_TEXT+ String.valueOf(appWidgetId), "D");
